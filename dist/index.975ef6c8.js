...
inputEl.addEventListener("input", (0, _lodashDebounceDefault.default)(onInputSearch, DEBOUNCE_DELAY));
function onInputSearch(evt) {
    ...
    (0, _fetchCountries.fetchCountries)(textInput).then((arr)=>{
        if (arr.length > 10) {
            (0, _notiflix.Notify).info("Too many matches found. Please enter a more specific name.");
            return;
        }
...
const renderAllMarkupElement = (arr)=>{
    if (arr.length === 1) {
        listEl.innerHTML = "";
        const markupInfo = (0, _markup.createInfoMarkup)(arr);
        infoEl.innerHTML = markupInfo;
    } else {
        infoEl.innerHTML = "";
        const markupList = (0, _markup.createListMarkup)(arr);
        listEl.innerHTML = markupList;
    }
};

},{"./css/styles.css":"1CY4s","./js/fetchCountries":"dKuy9","lodash.debounce":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5WWYd","./js/markup":"3TIfq"}],"1CY4s":[function() {},{}],"dKuy9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchCountries", ()=>fetchCountries);
const API_URL = "https://restcountries.com/v3.1/name";
const fetchCountries = (name)=>{
    return fetch(`${API_URL}/${name}?fields=name,capital,population,flags,languages`).then((resp)=>{
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createInfoMarkup", ()=>createInfoMarkup);
parcelHelpers.export(exports, "createListMarkup", ()=>createListMarkup);
var _stylesCss = require("../css/styles.css");
const createInfoMarkup = (arr)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../css/styles.css":"1CY4s"}],"1CY4s":[function() {},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
